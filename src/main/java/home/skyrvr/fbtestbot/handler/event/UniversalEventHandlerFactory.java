...
import home.skyrvr.fbtestbot.sender.MessageSender;
...
@Component
public class UniversalEventHandlerFactory extends EventHandlerFactory {

    private static final Logger logger = LoggerFactory.getLogger(UniversalEventHandlerFactory.class);
    private final MessageSender messageSender;

    @Autowired
    public UniversalEventHandlerFactory(MessageSender messageSender) {
        this.messageSender = messageSender;
    }

    @Override
    public TextMessageEventHandler createTextMessageEventHandler() {
        return event -> {
    ...
    @Override
    public AttachmentMessageEventHandler createAttachmentMessageEventHandler() {
        return event -> {
            ...
            messageSender.sendTextMessage(senderId, "Message with attachment received");
        };
    }

    @Override
    public QuickReplyMessageEventHandler createQuickReplyMessageEventHandler() {
        return event -> {
            ...
            messageSender.sendTextMessage(senderId, "Quick reply tapped");
        };
    }

    @Override
    public PostbackEventHandler createPostbackEventHandler() {
        return event -> {
    ...
    @Override
    public AccountLinkingEventHandler createAccountLinkingEventHandler() {
        return event -> {
    ...
    @Override
    public OptInEventHandler createOptInEventHandler() {
        return event -> {
    ...
    @Override
    public EchoMessageEventHandler createEchoMessageEventHandler() {
        return event -> {
    ...
    @Override
    public MessageDeliveredEventHandler createMessageDeliveredEventHandler() {
        return event -> {
    ...
    @Override
    public MessageReadEventHandler createMessageReadEventHandler() {
        return event -> {
    ...
    @Override
    public FallbackEventHandler createFallbackEventHandler() {
        return event -> {
