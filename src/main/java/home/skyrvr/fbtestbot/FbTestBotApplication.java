...
public class FbTestBotApplication {

	private static final Logger logger = LoggerFactory.getLogger(FbTestBotApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(FbTestBotApplication.class, args);
	}
}
